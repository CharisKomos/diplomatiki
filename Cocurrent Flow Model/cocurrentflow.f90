...
program cocurrentflow
  use membrane_modules_cocurrent
  ...
  Do While(.TRUE.)
    ...
    Call solve(module2)
    Call configure(module3, 'Module 3', module1%y(nx), theta3, c3*module1%y(nx), module1%Vp)
    Call solve(module3)

    ! Recycling - Recalculate Lf and xf
    xf_old = xf
    Lf = (Lf0 + module2%Vp + module3%Lo)
    xf = (Lf0*xf0 + module2%Vp*module2%y(nx) + module3%Lo*module3%x(nx))/Lf
